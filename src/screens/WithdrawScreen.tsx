      ...
      <ScrollView contentContainerStyle={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.box}>
          ...
          <TextInput
            ...
            placeholder="Enter bank account number, PayPal email, or crypto wallet address"
            placeholderTextColor="#94A3B8"
        ...
        {/* Important Notes */}
        <View style={styles.box}>
          <Text style={styles.boxHeading}>Important Notes</Text>
          {[
            'Withdraws may take 1-5 business days to clear depending on the method.',
            'Ensure all details are accurate to avoid delays or loss of funds.',
            'Minimum Withdraw amount is $10.00.',
            'A small fee may apply for certain withdrawal methods.',
          ].map((note, i) => (
